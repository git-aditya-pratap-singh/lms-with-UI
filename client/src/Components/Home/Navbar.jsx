  ...
  return (
    <>
      <nav className="shadow-nav">
        ...
        <div className={`_navbar transition-all-duration-700 ease duration-700 ${toggle ? 'left-0' : 'left-[100%]'}`}>
          <ul>
            <li>
              <NavLink to="/" activeclassname="active" className="_navItem" onClick={() => setToggle(!toggle)}><FaHome />Home</NavLink>
            </li>
            <li>
              <NavLink to="/about" className="_navItem" onClick={() => setToggle(!toggle)}><FaUser />About</NavLink>
            </li>
            <li>
              <NavLink to="/service" className="_navItem" onClick={() => setToggle(!toggle)}><FaChartPie />Service</NavLink>
            </li>
            <li>
              <NavLink to="/contact" className="_navItem" onClick={() => setToggle(!toggle)}><FaPhoneAlt />Contact</NavLink>
            </li>
          </ul>
        </div>
