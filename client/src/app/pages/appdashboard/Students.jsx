                ...
                <div className="_studentSubConatiner1">
                    <div className="_studentSearch">
                        ...
                        <div className="_searchToggle">
                            <label className="mb-2 text-sm font-medium text-[var(--foreground)] sr-only ">Search</label>
                            <div className="relative">
                                ...
                                <input type="search" id="default-search" className="w-full p-2 ps-10 text-sm text-[var(--foreground)] rounded-lg
                                    bg-[var(--background)] ring-1 ring-gray-300 focus:ring-[var(--primary)] outline-none focus:shadow-md" placeholder="Search..." onChange={searchInput} />
                            </div>
                        </div>
                    </div>
                ...
                <div className="_studentSubContainer2">
                    <div className="_tableHeader">
                        <div role="tablist" className="tabs tabs-lifted _tav">
                            <a role="tab" className="tab tab-active [--tab-bg:var(--primary);] [--tab-border-color:aliceblue] text-[var(--foreground)]">All<span>(45)</span></a>
