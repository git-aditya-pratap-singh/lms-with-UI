    ...
    <>
     ...
     {(otpStatus.otpLogin || otpStatus.forgetPswdOtp) && <OtpLayout />}
      ...
      <nav className="shadow-nav">
        ...
        <label className="bg-[var(--primary)] swap swap-rotate lg:right-16 fixed top-[5.6rem] lg:top-[5.2rem] -z-10 p-2 text-white rounded">
      ...
      {toggle_top == true && (
        <div
          className="bg-[var(--primary)] p-3 rounded-full shadow-lg shadow-blue-500/70 z-10 bottom-[3%] right-[2%] fixed cursor-pointer"
