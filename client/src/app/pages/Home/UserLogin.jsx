...
import { user_login_popup } from "../../redux/Slices/StateSlice";
...
//--------------CSS--------------------
import "../../../assets/css/home/_userLogin.scss";
        ...
        <>
            <section className="_loginContainer">
                <div className="_loginForm">
                    ...
                    <h3 onClick={() => dispatch(user_login_popup(false))}>
                        <RxCross1 />
                    </h3>
                    <h1>Welcome Back!</h1>
                    <p>Choose one of the option to go.</p>

                    <div className="_userSelect">
                        <input type="button" name="Student" className="" value="Student" onClick={() => setFormStatus(false)} ref={buttonRef}/>
                        <input type="button" name="Teacher" className="" value="Teacher" onClick={() => setFormStatus(true)} />
                    </div>

                    <section className="overflow-hidden">
                        <div className={`w-[600px] p-[0.1rem] flex flex-row justify-between gap-x-1 
                          ${formStatus ? "scorllLeftForm" : "scorllRightForm"} `}>
                            <form onSubmit={handleSubmit} className={`_form2 w-full`}>
                                <span>
                                    <input
                                        type="text"
